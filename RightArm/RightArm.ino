...
long unsigned int ArduinoID = 0x1881ABBA;
//////////////////////////////////////////////////////////////////////////////////////////
//
...
unsigned char Max[6] = {50,171,171,171,171,171};
unsigned char CurrentPos[6] = {65,90,90,90,90,90};
...
//unsigned char StartPos[6] = {65,90,90,90,90,90};
for (int i = 0;i <6; i++)
{
 Actuate(i,StartPos[i]);
}
